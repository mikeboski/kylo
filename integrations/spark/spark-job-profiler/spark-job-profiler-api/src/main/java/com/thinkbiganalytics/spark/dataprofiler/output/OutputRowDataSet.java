...
public class OutputRowDataSet implements Serializable {
     ...
     */
    public OutputRowDataSet(String columnName, String metricType, String metricValue) {
