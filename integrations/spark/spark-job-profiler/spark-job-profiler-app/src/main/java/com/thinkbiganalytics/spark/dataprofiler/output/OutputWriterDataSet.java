 ...
 */
public class OutputWriterDataSet implements Serializable {
    ...
    public static void writeModel(@Nonnull final StatisticsModel model, @Nonnull final ProfilerConfiguration profilerConfiguration, @Nonnull final SQLContext sqlContext,
        ...
        final OutputWriterDataSet writer = new OutputWriterDataSet(profilerConfiguration);
    ...
    private OutputWriterDataSet(@Nonnull final ProfilerConfiguration profilerConfiguration) {
